...
namespace MemberManagerLibrary
{
    public class SqlServerMemberManager : IMemberManager
    {
        ...
        private string _connectionString = $@"Server=tcp:professionaltraining.database.windows.net,1433;Initial Catalog=trainingdb;Persist Security Info=False;User ID=xxxxxxx;Password=Training2023#@!;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
